...
const CarritoDeCompras = () => {
  ...
  return (
    <>
      <Header />
      <main>
        <section className="seleccion-producto container py-4">
          <h2>Selecciona tu Pastel:</h2>
          <div className="opciones d-flex gap-2 align-items-center">
            <select
        ...
        <div className="modal" style={{ display: 'block' }}>
          <div className="modal-contenido container py-3">
                  ...
                  {carrito.length === 0 ? (
                    ...
                    carrito.map(item => (
                      <tr key={item.nombre}>
                        ...
                        <td>
                          <button className="btn btn-sm btn-danger" onClick={() => handleEliminar(item.nombre)}>Eliminar</button>
                        </td>
                      </tr>
                    ))
                  )}
            ...
            <div className="formulario-cliente">
              ...
              <input type="text" id="nombre-cliente" placeholder="Nombre completo" className="form-control mb-2" />
              <input type="email" id="email-cliente" placeholder="Correo electrónico" className="form-control mb-2" />
              <input type="tel" id="telefono-cliente" placeholder="Teléfono" className="form-control mb-2" />
            </div>
